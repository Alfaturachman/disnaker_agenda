...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url('agenda_mediasi/add'); ?>" method="post">
                <div class="form-group">
                    <label for="nama_pihak_satu">Nama Pihak 1</label>
                    <input type="text" class="form-control" id="nama_pihak_satu" name="nama_pihak_satu" value="<?= set_value('nama_pihak_satu'); ?>">
                    <?= form_error('nama_pihak_satu', '<small class="text-danger">', '</small>'); ?>
                </div>
                <div class="form-group">
                    <label for="nama_pihak_dua">Nama Pihak 2</label>
                    <input type="text" class="form-control" id="nama_pihak_dua" name="nama_pihak_dua" value="<?= set_value('nama_pihak_dua'); ?>">
                    <?= form_error('nama_pihak_dua', '<small class="text-danger">', '</small>'); ?>
                </div>
                <div class="form-group">
                    <label for="nama_kasus">Nama Kasus</label>
                    <input type="text" class="form-control" id="nama_kasus" name="nama_kasus" value="<?= set_value('nama_kasus'); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="tgl_mediasi" name="tgl_mediasi" value="<?= set_value('tgl_mediasi'); ?>">
                    <?= form_error('tgl_mediasi', '<small class="text-danger">', '</small>'); ?>
                </div>
                <div class="form-group">
                    <label for="waktu_mediasi">Waktu Mediasi</label>
                    <input type="time" class="form-control" id="waktu_mediasi" name="waktu_mediasi" value="<?= set_value('waktu_mediasi'); ?>">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="status" name="status">
                        ...
                        <option value="disetujui" <?= set_select('status', 'disetujui'); ?>>Disetujui</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="jenis_kasus" name="jenis_kasus" value="<?= set_value('jenis_kasus'); ?>">
                    <?= form_error('jenis_kasus', '<small class="text-danger">', '</small>'); ?>
                </div>
                <div class="form-group">
                    <label for="deskripsi_kasus">Deskripsi Kasus</label>
                    <input type="text" class="form-control" id="deskripsi_kasus" name="deskripsi_kasus" value="<?= set_value('deskripsi_kasus'); ?>">
