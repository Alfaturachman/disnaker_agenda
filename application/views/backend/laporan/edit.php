        ...
        <div class="card-body">
            <form action="<?= base_url('laporan/edit/' . $laporan['id_laporan']); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <?= form_error('nama_kasus', '<div class="text-danger">', '</div>'); ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?= form_error('nama_pihak_satu', '<div class="text-danger">', '</div>'); ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?= form_error('nama_pihak_dua', '<div class="text-danger">', '</div>'); ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?= form_error('jenis_kasus', '<div class="text-danger">', '</div>'); ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?= form_error('tanggal_mediasi', '<div class="text-danger">', '</div>'); ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?= form_error('tgl_penutupan', '<div class="text-danger">', '</div>'); ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?= form_error('hasil_mediasi', '<div class="text-danger">', '</div>'); ?>
                </div>
